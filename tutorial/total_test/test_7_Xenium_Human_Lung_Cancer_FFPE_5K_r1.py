...
# 保存GGM
start_time = time.time()
sg.save_ggm(ggm, "data/Human_Lung_Cancer_5K.ggm.h5")
print(f"Time: {time.time() - start_time:.5f} s")
...
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="leiden_0.5_ggm", 
              save="/Human_Lung_Cancer_5K_ggm_modules_leiden_0.5.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="leiden_1_ggm",
                save="/Human_Lung_Cancer_5K_ggm_modules_leiden_1.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="louvan_0.5_ggm",
                save="/Human_Lung_Cancer_5K_ggm_modules_louvan_0.5.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="louvan_1_ggm",
                save="/Human_Lung_Cancer_5K_ggm_modules_louvan_1.pdf",show=True)
...
# %%
adata.uns['module_stats'].to_csv("data/Human_Lung_Cancer_5K_ggm_module_stats.csv")
...
# %%
# 保存注释结果
adata.obs.to_csv("data/Human_Lung_Cancer_5K_ggm_annotation.csv")


# %%
# 注释结果可视化并保存可视化结果
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation", 
              save="/Human_Lung_Cancer_5K_All_modules_annotation.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation_filtered",
                save="/Human_Lung_Cancer_5K_Filtered_modules_annotation.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation_no_activity",
                save="/Human_Lung_Cancer_5K_No_activity_modules_annotation.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation_no_spatial",
                save="/Human_Lung_Cancer_5K_All_modules_annotation_no_spatial.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation_filtered_no_spatial",
                save="/Human_Lung_Cancer_5K_Filtered_modules_annotation_no_spatial.pdf",show=True)
sc.pl.spatial(adata, spot_size=12, title= "", frameon = False, color="ggm_annotation_no_activity_no_spatial",
                save="/Human_Lung_Cancer_5K_No_activity_modules_annotation_no_spatial.pdf",show=True)


# %%
# 保存adata
adata.write("data/Human_Lung_Cancer_5K_ggm_anno.h5ad")


# %%
# 逐个可视化各个模块的注释结果
anno_modules = adata.uns['module_stats']['module_id']
pdf_file = "figures/xenium/Human_Lung_Cancer_5K_all_modules_Anno.pdf"
...
for module in anno_modules:
    ...
    show_png_file = f"figures/xenium/Human_Lung_Cancer_5K_{module}_Anno.png"
