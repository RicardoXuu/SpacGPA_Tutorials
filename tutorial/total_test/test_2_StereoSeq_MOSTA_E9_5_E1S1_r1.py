...
# %%
# 使用SpacGPA对 MOATA_E9.5_E1S1 数据进行分析
import numpy as np
import pandas as pd
import random
import time
...
# %%
# 读取空转数据
adata = sc.read_h5ad("/dta/ypxu/ST_GGM/VS_Code/ST_GGM_dev_1/data/MOSTA/E9.5_E1S1.MOSTA.h5ad")
...
# 保存GGM
start_time = time.time()
sg.save_ggm(ggm, "data/MOSTA_E9.5_E1S1.ggm.h5")
print(f"Time: {time.time() - start_time:.5f} s")

# %%
ggm = sg.load_ggm("data/MOSTA_E9.5_E1S1.ggm.h5")
...
# %%
adata.uns['module_stats'].to_csv("data/MOSTA_E9.5_E1S1_ggm_module_stats.csv")
...
# %%
# 保存注释结果
adata.obs.to_csv("data/MOSTA_E9.5_E1S1_ggm_annotation.csv")
...
for module in anno_modules:
    ...
    show_png_file = f"figures/MOSTA/E9_5_E1S1_{module}_Anno.png"
