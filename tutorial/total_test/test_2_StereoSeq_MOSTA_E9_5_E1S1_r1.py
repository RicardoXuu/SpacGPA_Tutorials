...
# %%
# 保存注释结果
adata.obs.to_csv("data/E9.5_E1S1.MOSTA.annotation.csv")
...
# %%
# 保存adata
adata.write("data/E9.5_E1S1.MOSTA_ggm_anno.h5ad")


# %%
# 逐个可视化各个模块的注释结果
anno_modules = adata.uns['module_stats']['module_id'].unique()
pdf_file = "figures/MOSTA/All_modules_in_E9_5_E1S1_Module_Anno.pdf"
...
for module in anno_modules:
    ...
    show_png_file = f"figures/MOSTA/{module}_in_E9_5_E1S1_Module_Anno.png"
