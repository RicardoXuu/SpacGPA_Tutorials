...
# %%
adata_test_visium = sc.read_visium("/dta/ypxu/ST_GGM/Raw_Datasets/visium/CytAssist_FFPE_Mouse_Brain_Rep1",
                       count_file="CytAssist_FFPE_Mouse_Brain_Rep1_filtered_feature_bc_matrix.h5")
adata_test_visium.var_names = adata_test_visium.var['gene_ids']

# %%
adata_test_hd = sc.read_visium("/dta/ypxu/ST_GGM/Raw_Datasets/visium_HD/Mouse_Brain_Fixed_Frozen/binned_outputs/square_016um/",
                       count_file="filtered_feature_bc_matrix.h5")
adata_test_hd.var_names = adata_test_hd.var['gene_ids']

# %%
adata_test_sc = sc.read_h5ad('WMB-10Xv3-all-downsampled.h5ad')