...
# %%
# 尝试开发多切片联合分析的函数，使用 小鼠大脑的三个数据集的共5张切片数据进行测试
import numpy as np
import pandas as pd
import random
import time
...
ggm_1 = ST_GGM_Pytorch(adata_1,
                        round_num=20000, 
                        dataset_name = "CytAssist_FFPE_Mouse_Brain_Rep1", 
                        selected_num=2000, 
                        cut_off_pcor=0.03,
                        run_mode=2, 
                        double_precision=False,
...
ggm_1.fdr_control()
cut_pcor = ggm_1.fdr.fdr[ggm_1.fdr.fdr['FDR'] <= 0.05]['Pcor'].min()
if cut_pcor < 0.03:
    cut_pcor = 0.03
print("adata_1 Adjust cutoff pcor:", cut_pcor)
ggm_1.adjust_cutoff(pcor_threshold=cut_pcor)
...
ggm_2 = ST_GGM_Pytorch(adata_2,
                        round_num=20000, 
                        dataset_name = "CytAssist_FFPE_Mouse_Brain_Rep2", 
                        selected_num=2000, 
                        cut_off_pcor=0.03,
                        run_mode=2, 
                        double_precision=False,
...
ggm_2.fdr_control()
cut_pcor = ggm_2.fdr.fdr[ggm_2.fdr.fdr['FDR'] <= 0.05]['Pcor'].min()
if cut_pcor < 0.03:
    cut_pcor = 0.03
print("adata_2 Adjust cutoff pcor:", cut_pcor)
ggm_2.adjust_cutoff(pcor_threshold=cut_pcor)
...
ggm_3 = ST_GGM_Pytorch(adata_3,
                        round_num=20000, 
                        dataset_name = "CytAssist_FreshFrozen_Mouse_Brain_Rep1", 
                        selected_num=2000, 
                        cut_off_pcor=0.03,
                        run_mode=2, 
                        double_precision=False,
...
ggm_3.fdr_control()
cut_pcor = ggm_3.fdr.fdr[ggm_3.fdr.fdr['FDR'] <= 0.05]['Pcor'].min()
if cut_pcor < 0.03:
    cut_pcor = 0.03
print("adata_3 Adjust cutoff pcor:", cut_pcor)
ggm_3.adjust_cutoff(pcor_threshold=cut_pcor)
...
ggm_4 = ST_GGM_Pytorch(adata_4,
                        round_num=20000, 
                        dataset_name = "CytAssist_FreshFrozen_Mouse_Brain_Rep2",
                        selected_num=2000, 
                        cut_off_pcor=0.03,
                        run_mode=2, 
                        double_precision=False,
...
ggm_4.fdr_control()
cut_pcor = ggm_4.fdr.fdr[ggm_4.fdr.fdr['FDR'] <= 0.05]['Pcor'].min()
if cut_pcor < 0.03:
    cut_pcor = 0.03
print("adata_4 Adjust cutoff pcor:", cut_pcor)
ggm_4.adjust_cutoff(pcor_threshold=cut_pcor)
...
ggm_5 = ST_GGM_Pytorch(adata_5,
                        round_num=20000, 
                        dataset_name = "CytAssist_Fresh_Frozen_Mouse_Brain",
                        selected_num=2000, 
                        cut_off_pcor=0.03,
                        run_mode=2, 
                        double_precision=False,
...
ggm_5.fdr_control()
cut_pcor = ggm_5.fdr.fdr[ggm_5.fdr.fdr['FDR'] <= 0.05]['Pcor'].min()
if cut_pcor < 0.03:
    cut_pcor = 0.03
print("adata_5 Adjust cutoff pcor:", cut_pcor)
ggm_5.adjust_cutoff(pcor_threshold=cut_pcor)
...
# %%
# 可视化注释结果
sc.pl.spatial(adata_1, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_combined", 
              save="/CytAssist_FFPE_Mouse_Brain_Rep1_annotation_combined.pdf",show=False)
sc.pl.spatial(adata_2, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_combined",
                save="/CytAssist_FFPE_Mouse_Brain_Rep2_annotation_combined.pdf",show=False)
sc.pl.spatial(adata_3, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_combined",
                save="/CytAssist_FreshFrozen_Mouse_Brain_Rep1_annotation_combined.pdf",show=False)
sc.pl.spatial(adata_4, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_combined",
                save="/CytAssist_FreshFrozen_Mouse_Brain_Rep2_annotation_combined.pdf",show=False)
sc.pl.spatial(adata_5, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_combined",
                save="/CytAssist_Fresh_Frozen_Mouse_Brain_annotation_combined.pdf",show=False)

# %%
# 保存数据
adata_1.write('data/CytAssist_FFPE_Mouse_Brain_Rep1_Combined_Anno.h5ad')
adata_2.write('data/CytAssist_FFPE_Mouse_Brain_Rep2_Combined_Anno.h5ad')
adata_3.write('data/CytAssist_FreshFrozen_Mouse_Brain_Rep1_Combined_Anno.h5ad')
adata_4.write('data/CytAssist_FreshFrozen_Mouse_Brain_Rep2_Combined_Anno.h5ad')
adata_5.write('data/CytAssist_Fresh_Frozen_Mouse_Brain_Combined_Anno.h5ad')
...
# %%
# 可视化注释结果
sc.pl.spatial(adata_1, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_self", 
              save="/CytAssist_FFPE_Mouse_Brain_Rep1_annotation_self.pdf",show=False)
sc.pl.spatial(adata_2, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_self",
                save="/CytAssist_FFPE_Mouse_Brain_Rep2_annotation_self.pdf",show=False)
sc.pl.spatial(adata_3, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_self",
                save="/CytAssist_FreshFrozen_Mouse_Brain_Rep1_annotation_self.pdf",show=False)
sc.pl.spatial(adata_4, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_self",
                save="/CytAssist_FreshFrozen_Mouse_Brain_Rep2_annotation_self.pdf",show=False)
sc.pl.spatial(adata_5, alpha_img = 0.5, size = 1.6, title= "", frameon = False, color="annotation_self",
                save="/CytAssist_Fresh_Frozen_Mouse_Brain_annotation_self.pdf",show=False)

# %%
# 保存数据
adata_1.write('data/CytAssist_FFPE_Mouse_Brain_Rep1_Self_Anno.h5ad')
adata_2.write('data/CytAssist_FFPE_Mouse_Brain_Rep2_Self_Anno.h5ad')
adata_3.write('data/CytAssist_FreshFrozen_Mouse_Brain_Rep1_Self_Anno.h5ad')
adata_4.write('data/CytAssist_FreshFrozen_Mouse_Brain_Rep2_Self_Anno.h5ad')
adata_5.write('data/CytAssist_Fresh_Frozen_Mouse_Brain_Self_Anno.h5ad')
