...
# 保存GGM
start_time = time.time()
sg.save_ggm(ggm, "data/Human_Lung_Cancer_5K_r3.ggm.h5")
print(f"Time: {time.time() - start_time:.5f} s")

# %%
# 读取GGM
start_time = time.time()
ggm = sg.load_ggm("data/Human_Lung_Cancer_5K_r3.ggm.h5")
print(f"Time: {time.time() - start_time:.5f} s")
...
# %%
adata.uns['module_stats'].to_csv("data/Human_Lung_Cancer_5K_ggm_module_stats_r3.csv")
...
mod_cor = sg.calculating_module_similarity(adata,
                                ...
                                save_plot_as="figures/Human_Lung_Cancer_5K_module_corr_similarity_r3.pdf"  
                                )
...
pdf_file = "figures/xenium/Human_Lung_Cancer_5K_all_modules_Anno_r3.pdf"
...
for module in anno_modules:
    ...
    show_png_file = f"figures/xenium/Human_Lung_Cancer_5K_{module}_Anno_r3.png"
