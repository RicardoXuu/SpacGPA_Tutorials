...
sg.module_network_plot(nodes_edges = M1_edges, nodes_anno = M1_anno, seed = 2) 
...
sg.module_go_enrichment_plot(ggm, top_n_modules = 5, go_per_module = 1)
...
sg.module_mp_enrichment_plot(ggm, top_n_modules = 5, mp_per_module = 1)
...
sg.module_network_plot(nodes_edges = M1_edges, nodes_anno = M1_anno, highlight_anno = "GO:0030016", seed = 2)
print(ggm.mp_enrichment.iloc[0, :5])
sg.module_network_plot(nodes_edges = M1_edges, nodes_anno = M1_anno, highlight_anno = "MP:0005369", seed = 2)
...
sg.module_dot_plot(adata, ggm_key = 'ggm', groupby = 'annotation', 
